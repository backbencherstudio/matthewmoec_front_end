      ...
      <section className="flex p-4 md:p-8 lg:p-20 justify-center items-center  bg-linear-to-b from-[#395CBC] to-[#1A2A56]">
        <div className="grid grid-cols-1 gap-10 items-center justify-center">
          ...
          <div className="  flex flex-col justify-center items-center gap-4 sm:flex-row">
            <button
              className="w-full sm:w-65 flex h-12 lg:h-14 px-3 lg:px-6 py-2 lg:py-4 justify-center items-center  rounded-[30px] 
                bg-linear-to-b from-[#395CBC] to-[#1A2A56] text-[#FFF] font-medium  text-[12px] md:text-[12px]  lg:text-[16px] leading-[100%] tracking-[0.08px] font-inter cursor-pointer"
            >
            ...
            <button
              className=" w-full sm:w-65 flex h-12 lg:h-14 px-3 lg:px-6 py-2 lg:py-4 justify-center items-center  shrink-0 
  rounded-[30px] border border-[#FFF] text-white font-medium text-[12px] md:text-[12px]  lg:text-[16px] leading-[100%] tracking-[0.08px] font-inter cursor-pointer text-nowrap"
            >
