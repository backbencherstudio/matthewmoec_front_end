  ...
  return (
    <div className="px-13 py-10 relative overflow-hidden h-screen">
      ...
      <div className="flex items-center justify-between">
        ...
        <button className="bg-linear-to-b from-[#3658B3] to-[#1F3265] text-white py-4 px-8 text-base leading-[124%] tracking-[0.08px] rounded-full cursor-pointer transition-colors">
          Add New Store
        </button>
      </div>
      <div className="mt-6">
