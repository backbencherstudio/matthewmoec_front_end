...
export default function OurMission() {
  const items = [
    "Make supporting good causes effortless by turning your everyday shopping into meaningful impact without any extra steps.",
    "Ensure every action taken by users contributes to a clear and measurable impact.",
    "Build trust through complete transparency in how support is earned and shared.",
      ...
      <Container>
        <div className="bg-white border border-gray-200 rounded-2xl px-8 py-10 mx-auto sm:px-12">
          ...
          <p className="text-center text-[#1A2A56] text-lg leading-[132%] tracking-[0.09px] mb-4 lg:mb-10">
           You shop, we share support every month — completely free. No account required.
          </p>
